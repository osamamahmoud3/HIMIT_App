  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        ...
        child: BlocConsumer<AskaryaCubit, AskaryaState>(
          ...
          final cubitaskaryadata =
              BlocProvider.of<AskaryaCubit>(context, listen: false);
          print(cubitaskaryadata.askreyaModel?.serialNumber);
          print(cubitaskaryadata.askreyaModel?.serialNumber != null);
          if (state is AskaryaLouding) {
            return Scaffold(
                  drawer: Drawerr(),
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: CustomContainer(
                                        number:
                                            "${cubitaskaryadata.askreyaModel?.num![index]}"),
                                  );
                                }),
                          ),
                        ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      CustomText2(
                                        //where is the number ?
                                        datee:
                                            '${cubit.authModel?.serialNumber} : مسلسل',
                                      ),
                                      verticalSpace(26),
                                      CustomText2(
                                        datee:
